...
class Homework(models.Model):
    ...
    status = models.CharField(max_length=50, choices=HomeworkStatus.choices, default='Tasked')
    task_load = models.FileField(default='', upload_to='txts', null=True)
